...
///<<<<<<< Updated upstream
                                        ...
                                        Seller s = new Seller(pass, emailc, fname, lname, Integer.parseInt(phoneN), uid);
            ...
            }}else {   Toast.makeText(signup.this, "تأكد من تعبئة جميع الحقول", Toast.LENGTH_SHORT).show();
        }
