...
public class chatroom_adapter2 extends ArrayAdapter<Chatroom> {
    ...
    FirebaseAuth mAuth;
    public chatroom_adapter2(Activity context, List<Chatroom> artists) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        myRef.child("seller").child(artist.getFID()).addValueEventListener(new ValueEventListener() {
            @Override
