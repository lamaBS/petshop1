...
public class viewallEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewArtists = (ListView) findViewById(R.id.listViewTrack);
        ...
        myRef.child("Event").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    event artist =new event(ds.getValue(event.class));
                    artists.add(artist);
                }
                ...
                arrayEvent artistAdapter = new arrayEvent(viewallEvent.this, artists);
    ...
    private void deleteitem(String item) {
        ...
        DatabaseReference dR = FirebaseDatabase.getInstance().getReference("Event").child(item);
        //removing artist
        dR.removeValue();
